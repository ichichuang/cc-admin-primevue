...
.c-card-accent.bg-bg100.c-border.rounded-full.gap-4px.p-2(
  ...
  .center.rounded-full.p-paddings(
    ...
    div(
      :class='[isDark ? "icon-line-md:moon-twotone-alt-loop" : "icon-line-md:sunny-outline-twotone"]'
    )
  ...
  .center.rounded-full.p-paddings(
    ...
    div(
      :class='[isDark ? "icon-line-md:sunny-outline-twotone" : "icon-line-md:moon-twotone-alt-loop"]'
    )
